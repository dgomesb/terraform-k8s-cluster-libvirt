...
variable "vn_name" {
  description = "A new Virtual Network will be created with this name"
  type        = string
  default     = "k8s"
}
...
variable "user_passwd" {
  ...
  validation {
    ...
    error_message = <<-EOT
      WARNING: Empty password detected. The user will be able to log in
      without a password. To fix this, provide a hash generated by:
...
variable "shared_config" {
  ...
  type = object({
    ...
    base_os      = optional(string, null) ## from locals
    #userdata.tpl
